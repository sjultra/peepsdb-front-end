...
const ConnectionsModal = ({ view,padd,setValues,close,initPayload }) => {
  ...
  const ConnectionViews = {
    ...
    onboarding: {      
      ...
      subText: "You can Collect your info from your other accounts to ease your onboarding process",
...

      {
        ...
        <>
          ...
          <Flex 
            mt='0.6em'
            justify={'space-between'}
            borderTop="1px solid rgba(0,0,0,0.1)" pt='1.3em'>

              <Btn onClick={()=>setFetched(false)} px='1.3em' variant={'fade'}>
                Back
              </Btn>

              <Btn px='1.3em' onClick={()=>{
          ...
          <Box>
            ...
            >
                ...
                <Box>
                    ...
                    <Text textAlign={view==='onboarding'? 'center':'initial'} mt="0.2em" fontSize={"12px"}>
                    {ConnectionViews[view].actionText} your Google{" "}
                    </Text>
                </Box>
                </Flex>

                <Btn onClick={ConnectionViews[view]?.googleConnect} h='30px' px='0.8em'>
            ...
            >
                ...
                <Btn  onClick={ConnectionViews[view]?.githubConnect} h='30px' px='0.8em'>
                    {ConnectionViews[view].text}            
                </Btn>
            ...
            >
                ...
                <Btn onClick={ConnectionViews[view]?.linkedinConnect} h='30px' px='0.8em'>
                    {ConnectionViews[view].text}            
                </Btn>
